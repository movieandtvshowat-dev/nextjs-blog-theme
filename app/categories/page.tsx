...
//   title: 'Movie Categories - Movie & Tvshow ',
...
//   const genres = [...new Set(moviesData.flatMap(movie => movie.genre.split(', ')))]
...
//                   key={index} 
//                   category={category} 
//                   movieCount={moviesData.filter(m => m.category === category).length}
//                 />
//               ))}
//             </div>
//           </section>
...
//               <h2 className="text-2xl font-semibold mb-6">{category} Movies</h2>
//               <MovieGrid 
//                 movies={moviesData.filter(movie => movie.category === category)} 
//                 title=""
//               />
//             </section>
//           ))}
...
//   return (
//     <div className="bg-netflix-gray rounded-lg overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer group">
//       <div className="aspect-video bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center">
//         <h3 className="text-xl font-bold text-white text-center p-4">{category}</h3>
//       </div>
//       <div className="p-4">
//         <p className="text-gray-400 text-sm">{movieCount} movies</p>
//       </div>
//     </div>
//   )
// }
...
//   return (
//     <span className="bg-netflix-gray px-4 py-2 rounded-full text-sm hover:bg-netflix-red transition cursor-pointer">
//       {genre}
//     </span>
//   )
// }
