...
export const metadata = {
  title: 'Help & Support - Movie & Tvshow',
  description: 'Get help with Movie & Tvshow. Troubleshooting guides, FAQs, and direct Telegram support.',
  keywords: 'Movie & Tvshow help, support, troubleshooting, telegram help',
}
