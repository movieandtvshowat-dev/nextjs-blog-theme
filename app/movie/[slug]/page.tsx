...
//   thumbnail: string
//   videoId: string
//   videoSource?: 'shortICU' | 'dailymotion' // Add video source field
//   releaseYear: string
//   duration: string
//   quality: string
//   rating: string
...
//   const movie = moviesData.find((m: Movie) => m.slug === params.slug)
  
//   if (!movie) {
//     return {
//       title: 'Movie Not Found - Movie & Tvshow',
//     }
//   }

//   return {
//     title: `${movie.title} | Watch Online Free - Movie & Tvshow`,
//     description: `${movie.description.substring(0, 160)}... Watch ${movie.title} in ${movie.quality} for free.`,
//     keywords: `${movie.title}, ${movie.genre}, ${movie.cast.join(', ')}, watch online, free streaming`,
//     openGraph: {
//       title: `${movie.title} - Movie & Tvshow`,
...
//       ],
//       type: 'video.movie',
//       url: `https://movieandtvshowat.netlify.app/movie/${movie.slug}`,
//     },
//     twitter: {
...
//     },
//     alternates: {
//       canonical: `https://movieandtvshowat.netlify.app/movie/${movie.slug}`,
//     },
//   }
// }
...
//   // Determine which player to use based on videoSource
...
//           <RelatedMoviesGrid
//             movies={moviesData.filter((m: Movie) => m.category === movie.category)}
//             currentMovieId={movie.id}
//             title={`More ${movie.category} Movies`}
//           />

//           <RelatedMoviesGrid
//             movies={moviesData.filter((m: Movie) => 
...
//                   "@type": "Organization",
//                   "name": "Movie & Tvshow",
//                   "url": "https://movieandtvshowat.netlify.app"
//                 },
//                 "publisher": {
//                   "@type": "Organization",
//                   "name": "Movie & Tvshow",
//                   "logo": {
//                     "@type": "ImageObject",
//                     "url": "https://movieandtvshowat.netlify.app/logo.png"
//                   }
//                 },
//                 "mainEntityOfPage": {
//                   "@type": "WebPage",
//                   "@id": `https://movieandtvshowat.netlify.app/movie/${movie.slug}`
//                 },
...
interface Movie {
  ...
  thumbnail: string
  videoId: string
  videoSource?: string // Make this more flexible
  releaseYear: string
  duration: string
  quality: string
  rating: string
