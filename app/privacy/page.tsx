...
export const metadata = {
  title: 'Privacy Policy - Movie & Tvshow',
  description: 'Movie & Tvshow privacy policy and data protection information.',
}
      ...
      <main className="pt-20 min-h-screen bg-netflix-black">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h2>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us at: privacy@Movie & Tvshow.com</p>
          </div>
        </div>
      </main>
    </>
