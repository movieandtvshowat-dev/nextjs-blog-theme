...
export const metadata = {
  title: 'Contact Us - Movie & Tvshow ',
  description: 'Get in touch with Movie & Tvshow support team via Telegram for any questions or issues.',
  keywords: 'contact Movie & Tvshow, support, help, telegram support',
}
