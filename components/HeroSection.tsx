...
//                 >
//                   <Play className="mr-2 group-hover:scale-110 transition-transform" size={18} className="md:w-5 md:h-5 lg:w-6 lg:h-6" />
//                   Play Now
//                 </Link>
...
//                   <Info className="mr-2 group-hover:scale-110 transition-transform" size={18} className="md:w-5 md:h-5 lg:w-6 lg:h-6" />
//                   More Info
//                 </button>
//                 <a 
//                   href="https://t.me/movieandtvshowat_bot" 
...
//                 >
//                   <MessageCircle className="mr-2 group-hover:scale-110 transition-transform" size={18} className="md:w-5 md:h-5 lg:w-6 lg:h-6" />
//                   Request Movie
//                 </a>
//               </div>
//             </div>
...
//                 >
//                   <MessageCircle className="mr-1 md:mr-2 group-hover:scale-110 transition-transform" size={16} className="md:w-4 md:h-4 lg:w-5 lg:h-5" />
//                   Request Movie
//                 </a>
//               </div>
